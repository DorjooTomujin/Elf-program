...
export const HomeTitle = () => {
  return (
    ...
    >
      ...
      <Box h={10} />
      <Text color={"white"} fontWeight="bold" fontSize={[16, 20, 20, 2, 32]}>
        REINVENTING EDUCATION WHILE MAKING IT ACCESSIBLE TO EVERYONE, EVERYWHERE
      </Text>
    </Container>
  );
};
...
export const Title = () => {
  return (
    <VStack gap={4} alignItems={"start"}>
      <HStack color={"white"} fontWeight={600} mb={5}>
...
export const ColorTitle = ({ color, title, wrap, align, width, size }) => {
  return (
    <Heading
      fontSize={size != undefined ? size : '70px'}
      display="block"
      whiteSpace={wrap != undefined ? wrap : "nowrap"}
      w={width != undefined ? width : "auto"}
      textAlign={align != undefined ? align : "start"}
      lineHeight={1}
      color={color}
      textTransform={"uppercase"}
    >
