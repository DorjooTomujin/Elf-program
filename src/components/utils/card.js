...
export const HexagonCard = () => {
  return (
    <Box pos={"relative"} h={0} pt={'80%'} maxH={'500px'}>
      ...
      <Box w={"40%"} bg={"green.main"} pos={'absolute'} top={'16.5%'} height={0} pt={"40%"} transform={'rotate(-60deg)'} left={'17%'}>
        <Center><Text pos={'absolute'} top={-8}>Lorem, ipsum dolor.</Text></Center>
      </Box>
      <Box w={"40%"} bg={"green.main"} pos={'absolute'} top={'34.5%'} height={0} pt={"40%"} transform={'rotate(60deg)'} left={'17%'}>
        <Center><Text >Lorem, ipsum dolor.</Text></Center>
      </Box>
      <Box w={"40%"} bg={"green.main"} pos={'absolute'} top={'43.5%'} height={0} pt={"40%"}  left={'50%'} transform={'translateX(-50%)'}>
        <Center><Text >Lorem, ipsum dolor.</Text></Center>
      </Box>
      <Box w={"40%"} bg={"green.main"} pos={'absolute'} top={'16.5%'} height={0} pt={"40%"} transform={'rotate(60deg)'} right={'17%'}>
        <Center><Text pos={'absolute'} top={-8}>Lorem, ipsum dolor.</Text></Center>
      </Box>
      <Box w={"40%"} bg={"green.main"} pos={'absolute'} top={'34.5%'} height={0} pt={"40%"} transform={'rotate(-60deg)'} right={'17%'}>
        <Center><Text >Lorem, ipsum dolor.</Text></Center>
      </Box>
      <Box pos={'absolute'} w={'70%'} top={8} left={'15%'} h={0} pt={'70%'} bg={'white'} borderRadius={'100%'}>
      </Box>
      <Box pos={'absolute'} w={'55%'} top={'16.5%'} left={'22.5%'} h={0} pt={'55%'} bg={'green.main'} borderRadius={'100%'}>
      </Box>
      <Box pos={'absolute'} w={'38.5%'} top={'26.5%'} left={'31%'} h={0} pt={'38.5%'} bg={'white'} >
      <Center><Text >Lorem, ipsum dolor.</Text></Center>
